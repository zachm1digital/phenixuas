...
function getData(): ContentProps[] {
  return [
    {
      type: 'main_title',
      title: 'Phenix Ultra 2XL Surveillance',
      subTitle: (
        <>
          <div>Surveillance and Imaging Services</div>
      ...
      content: (
        <>
          <p>
            Phenix Solutions Ultra 2XL is the right platform for a trusted eye in the sky. Our
            mission is simple: to provide unparalleled surveillance and imaging solutions to
            safeguard what matters most to the client or end user. The Ultra 2XL has a cutting-edge
            technology package for aerial observations, thus redefining the future of uncrewed
            surveillance.
          </p>
        </>
      )
      ...
      items: [
        {
          ...
          content: (
            <>
              This strategic advantage with our UAS Ultra 2XL allows you to protect your interests,
              enhance security measures, and stay one step ahead of potential threats.
            </>
          )
        },
        {
          ...
          content: (
            <>
              Every client is unique, and so is the surveillance of their needs. Our partners will
              work closely with you to design tailored solutions and address your concerns and
              objectives.
            </>
          )
        },
    ...
    },
    {
      ...
      content: (
        <p>
          The power of aerial surveillance and the peace of mind it brings is paramount. Contact us
          today to discuss your specific needs and schedule a consultation with our team so we can
          rise above the challenges for a secure world with you.
        </p>
      )
    }
  ];
