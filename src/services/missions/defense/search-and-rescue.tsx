...
function getData(): ContentProps[] {
  return [
    ...
    },
    {
      ...
      title: <>Ultra 2XL SAR Characteristics</>,
      items: [
        {
          ...
          content: (
            <>
              <p>
                ...
                covered by affordable aerial assets like the Ultra 2XL SAR. These life-and-death
                scenarios require urgent launch capability. The Ultra 2XL SAR is ready to take
                flight in under 15 minutes, and with RPAs controlling the Ultra 2XL SAR, we can
                pre-position aircraft 24/7 in the right locations to be launched for immediate
          ...
          content: (
            <>
              <p>
                ...
                conditions. Also, the Ultra 2XL SAR with cargo hook carousel can drop immediate
                support in safety equipment, rations, medical supplies, survival gear, etc.
              </p>
            </>
          )
        },
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                The Ultra 2XL SAR doesn&apos;t stop when the night or most weather conditions creep
                into an area of operation. Our night operations ensure continuous SAR efforts to
                track, locate, protect, resupply, and situational awareness for crewed aircraft to
    ...
    },
    {
      ...
      title: 'Why choose the Ultra 2XL SAR',
      items: [
        {
          title: 'Experience',
          content:
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Our team built the Ultra 2XL SAR configuration with our operators, agencies, and
            governments to ensure our aircraft&apos;s highest quality and capability. Our unwavering
            commitment is to our community and to help prevent loss of life on the ground, at sea,
            or in the air.
          </p>
          <p>
            Ready to meet the needs of your community with an Ultra 2XL SAR in your fleet with
            immediate deployment and unparalleled around-the-clock SAR capabilities? We are prepared
            to stand with you to save every life. Reach out to us today to discuss your SAR needs.
          </p>
        </>
      )
    },
