      ...
      content: (
        <>
          ...
          <p>
            ...
            practical assistance during natural disasters. Our mission is to work with first
            responders, delivering critical aid and relieving crewed aerial assets to handle
            recovery efforts for the communities in crisis.
          </p>
        </>
      )
    },
